...
from typing import Iterable, Type, Optional, Set
...
def generate_dto(__model_name, resource_bl_model_class, excluded_fields, **kwargs):
...
def generate_response_dto(__model_name, resource_bl_model_class: Type[BaseModel], **kwargs) -> Type[BaseDTO]:
...
def generate_patch_request_dto(__model_name, resource_bl_model_class: Type[BaseModel], patch_request_fields: Set,
                               **kwargs) -> Type[BaseDTO]:
...
def generate_request_dto(__model_name, resource_bl_model_class, **kwargs) -> Type[BaseDTO]:
    excluded_fields = {'id', 'created_at', 'updated_at', 'deleted_at'}
    dto_class = generate_dto(__model_name, resource_bl_model_class, excluded_fields, **kwargs)
    dto_class.__bl_model_class__ = resource_bl_model_class
    return dto_class
...
def generate_put_request_dto(__model_name, resource_bl_model_class, **kwargs):
